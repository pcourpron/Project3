...
const Navbar = (props)=>{
  ...
  <div className="collapse navbar-collapse" id="navbarNav">
    <ul className="navbar-nav ml-auto">
      ...
      {props.admin === true? <li><Link to='/adminCreateQuestion'><a className="nav-link" >Admin</a></Link> </li>: null}
     

     {props.name !== ''?<li> <a className="nav-link" onClick={props.logOut}>Sign Out</a></li>: null}
